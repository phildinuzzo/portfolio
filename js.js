...
// Navbar
	$('.navbutton').on('click', function(e){
		...
		if (!$(this).hasClass('active')) {
			...
			$('.content-container').children().fadeTo(500, 0.1);
			$('.content-container').slideUp(400, function(){
				$('#' + $(self).attr('id') + '-container').children().fadeTo(100, 1);
			});

			$('#' + $(this).attr('id') + '-container').delay(500).slideDown(500, function() {
        $('#' + $(self).attr('id') + '-container').children().fadeTo(400, 1);
      });
		}
	});
